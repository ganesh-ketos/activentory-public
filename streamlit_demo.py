...
def map_cols():
    ...
    df_map = pd.read_csv('C:/Users/livel/Documents/WDP/LSL_property_merged.csv')
    ...
    with c1:
        st.empty()
    with c2:
        image = Image.open('C:/Users/livel/Documents/WDP/Activentory.png')
    ...
    with c1:
        ...
        # Read data
        cache_path = 'C:/Users/livel/Documents/WDP/cache.csv'
    ...
    with c3:
        acc_cache_path = 'C:/Users/livel/Documents/WDP/acc_cache.csv'
